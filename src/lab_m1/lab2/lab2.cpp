...
void Lab2::Init()
{
    ...
    vector<VertexFormat> vertices_t
    {
        VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
    ...
    meshes["t_A"] = new Mesh("generated t 1");
    meshes["t_A"]->InitFromData(vertices_t, indices_t);
    CreateMesh("t_A", vertices_t, indices_t);

    // TODO(student): Create a square using two triangles with
    // opposing vertex orientations.

    vector<VertexFormat> vertices_s
    {
        VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
    ...
    vector<unsigned int> indices_s =
    {
        0, 1, 2,
        1, 2, 3
    };

    meshes["s_A"] = new Mesh("generated s 1");
    meshes["s_A"]->InitFromData(vertices_s, indices_s);
    CreateMesh("s_A", vertices_s, indices_s);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["t_A"], shaders["VertexColor"], glm::vec3(1, 0.5f, 1), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["s_A"], shaders["VertexColor"], glm::vec3(-1, 0.5f, 1), glm::vec3(0.25f));
