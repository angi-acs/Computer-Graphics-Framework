    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat4 rotateLocalOx = glm::rotate(model, angle, right);
            glm::vec4 forward4 = glm::vec4(forward, 1.f);
            forward4 = rotateLocalOx * forward4;
            forward = glm::normalize(glm::vec3(forward4));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::mat4 model = glm::mat4(1.f);
            glm::mat4 rotateWorldOY = glm::rotate(model, angle, glm::vec3(0, 1, 0));

            glm::vec4 forward4 = glm::vec4(forward, 1.f);
            forward4 = rotateWorldOY * forward4;
            forward = glm::normalize(glm::vec3(forward4));

            glm::vec4 right4 = glm::vec4(right, 1.f);
            right4 = rotateWorldOY * right4;
            right = glm::normalize(glm::vec3(right4));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 model = glm::mat4(1.f);
            glm::mat4 rotateLocalOZ = glm::rotate(model, angle, forward);
            glm::vec4 right4 = glm::vec4(right, 1.f);
            right4 = rotateLocalOZ * right4;
            right = glm::normalize(glm::vec3(right4));
            up = glm::cross(right, forward);
